...
- [Inference figures](inference-figures.md) — the `inference` shortcode.
- [Glossary and notation appendices](glossary.md) — `data/glossary.json` and `term`.

## Resources

- [Figures](figures.md) — the `img` shortcode and the SVG migration.
- [Exporting from Excalidraw](excalidraw-export.md) — the optional export script.
- [Solutions and passwords](solutions.md) — exercise disclosure controls.
- [Slides](slides.md) — what an author needs to know about the decks.
...
- [Staged release](staged-release.md) — locked chapters and legacy notation.
- [Checking your work](checking-your-work.md) — which command to run.
