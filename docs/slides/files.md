...
| `slides/unpublished/<topic>/`            | Staged Lectures 6–12: page metadata, any narration, plus rendered decks; mounted only by the local preview overlay. |
...
Lecture 1 to 5 scenes, all `slides/unpublished/` files, and every
normal-site deck except Lectures 1 to 5. These originals remain on the maintainer's disk
